...
def play_song(url):
    ...
    # Press the play button using pyautogui
    pyautogui.press('k')
...
def main():
    ...
    while True:
        ...
        if "Who are you?" in new_question:
            response = "Hi there! I'm BENi, your personal chatbot assistant. I was created by Aditya Tripathi and designed to assist students with their academic queries related to CBSE class 10th boards. Besides academics, I have expertise in various programming languages, including Python, Java, and C++. I can help you with coding projects, recommend online resources to learn programming, and even assist you with tech-related issues. When it comes to cybersecurity, I can provide tips on how to stay safe online and recommend cybersecurity tools to keep your devices secure. I'm still learning and improving every day, so feel free to ask me anything, and I'll do my best to help you out!"

        if response.strip() != "":
            print(Fore.CYAN + "BENi:", response)
            speak(response)
